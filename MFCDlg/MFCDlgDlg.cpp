...
BEGIN_MESSAGE_MAP(CMFCDlgDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BTN_ADD, &CMFCDlgDlg::OnBnClickedBtnAdd)
	ON_BN_CLICKED(IDC_BTN_SUBTRACT, &CMFCDlgDlg::OnBnClickedBtnSubtract)
	ON_BN_CLICKED(IDC_BTN_OUTPUT, &CMFCDlgDlg::OnBnClickedBtnOutput)
END_MESSAGE_MAP()
...
void CMFCDlgDlg::OnBnClickedBtnAdd()
{
	//CString str;
	//str.Format(_T("7+3=%d"), add(7, 3));
	//MessageBox(str);
...
void CMFCDlgDlg::OnBnClickedBtnSubtract()
{
	//CString str;
	//str.Format(_T("7-3=%d"), subtract(7, 3));
	//MessageBox(str);
}

void CMFCDlgDlg::OnBnClickedBtnOutput()
{
	//Point pt;
	//pt.output(100, 120);
}
